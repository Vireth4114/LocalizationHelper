...
Note that the key you pass to the position is the translated file path rather than the original one. Parameters work the same way as for regular texture translation.
